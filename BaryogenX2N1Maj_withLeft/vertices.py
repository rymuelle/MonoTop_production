...
V_63 = Vertex(name = 'V_63',
              particles = [ P.n, P.u, P.X1__tilde__ ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS1, L.FFS2 ],
              couplings = {(0,0):C.GC_23,(0,1):C.GC_17})

V_64 = Vertex(name = 'V_64',
              particles = [ P.n, P.u, P.X2__tilde__ ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS1, L.FFS2 ],
              couplings = {(0,0):C.GC_26,(0,1):C.GC_20})

V_65 = Vertex(name = 'V_65',
              particles = [ P.n, P.c, P.X1__tilde__ ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS1, L.FFS2 ],
              couplings = {(0,0):C.GC_24,(0,1):C.GC_18})

V_66 = Vertex(name = 'V_66',
              particles = [ P.n, P.c, P.X2__tilde__ ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS1, L.FFS2 ],
              couplings = {(0,0):C.GC_27,(0,1):C.GC_21})

V_67 = Vertex(name = 'V_67',
              particles = [ P.n, P.t, P.X1__tilde__ ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS1, L.FFS2 ],
              couplings = {(0,0):C.GC_25,(0,1):C.GC_19})

V_68 = Vertex(name = 'V_68',
              particles = [ P.n, P.t, P.X2__tilde__ ],
              color = [ 'Identity(2,3)' ],
              lorentz = [ L.FFS1, L.FFS2 ],
              couplings = {(0,0):C.GC_28,(0,1):C.GC_22})
...
V_71 = Vertex(name = 'V_71',
              particles = [ P.b__tilde__, P.d__tilde__, P.X1__tilde__ ],
              color = [ 'EpsilonBar(1,2,3)' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_56})

V_72 = Vertex(name = 'V_72',
              particles = [ P.b__tilde__, P.d__tilde__, P.X2__tilde__ ],
              color = [ 'EpsilonBar(1,2,3)' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_59})

V_73 = Vertex(name = 'V_73',
              particles = [ P.b__tilde__, P.s__tilde__, P.X1__tilde__ ],
              color = [ 'EpsilonBar(1,2,3)' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_57})

V_74 = Vertex(name = 'V_74',
              particles = [ P.b__tilde__, P.s__tilde__, P.X2__tilde__ ],
              color = [ 'EpsilonBar(1,2,3)' ],
              lorentz = [ L.FFS2 ],
...
V_79 = Vertex(name = 'V_79',
              particles = [ P.b, P.d, P.X1 ],
              color = [ 'Epsilon(1,2,3)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_12})

V_80 = Vertex(name = 'V_80',
              particles = [ P.b, P.d, P.X2 ],
              color = [ 'Epsilon(1,2,3)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_15})

V_81 = Vertex(name = 'V_81',
              particles = [ P.b, P.s, P.X1 ],
              color = [ 'Epsilon(1,2,3)' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_13})

V_82 = Vertex(name = 'V_82',
              particles = [ P.b, P.s, P.X2 ],
              color = [ 'Epsilon(1,2,3)' ],
              lorentz = [ L.FFS1 ],
